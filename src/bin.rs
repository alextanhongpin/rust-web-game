...
#[post("/new", data = "<name>")]
fn post_new(mut cookies: Cookies, name: Form<CharacterForm>, state: GameState) -> Result<Redirect, String> {
...
fn game(state: GameState, flash: Option<FlashMessage>) -> Template {
    ...
    let gvd = GameViewData { flash: flash, characters: characters.clone() };
